    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('request_data', utils.models_field.DictField(blank=True, null=True, verbose_name='请求数据')),
                ('request_meta', utils.models_field.DictField(blank=True, null=True, verbose_name='请求元数据')),
                ('response_status_code', models.CharField(blank=True, max_length=10, null=True, verbose_name='响应状态码')),
                ('response_data', utils.models_field.DictField(blank=True, null=True, verbose_name='响应数据')),
            ],
            options={
                'verbose_name': '用户配置',
